        ...
        <div className="w-1/2 mt-6 border-r">
          ...
          <div className="grid grid-cols-2 text-[#514E4E]">
            <div>
              ...
              <div className="mb-4">
                <h1 className="text-[#989FAD] text-sm">Material Description</h1>
            ...
            <div>
              ...
              <div className="mb-4">
                <h1 className="text-[#989FAD] text-sm">Unit of Measurement</h1>
                <span>PCS</span>
              </div>
              <div className="mb-4">
          ...
          <div className="flex items-center">
            ...
            <div className="relative">
              ...
              <div className="absolute top-[100px] text-center">
                <h1 className="text-[#989FAD] text-sm font-[600]">Machining</h1>
                <span>-</span>
              </div>
            </div>
          </div>
