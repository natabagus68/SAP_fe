...
import CastingResultModal from "./casting-result-modal";
...
export default function CastingModalView({ open, close }) {
  ...
  return (
    <>
          ...
          <div className="w-1/2 mt-6 px-[72px]">
            ...
            <div className="mb-6">
              ...
              <div className="flex items-center gap-3">
                ...
                />
                <span
                  className="text-[#20519F] text-sm cursor-pointer"
                  onClick={data.onResultQrCodeOpen}
                >
                  View Card
                </span>
              </div>
            ...
            <div className="mb-4">
              <h1 className="text-[#989FAD] text-sm font-[600]">Status</h1>
              <span className="text-[#12B569] font-[600]">On Process</span>
            </div>
            <div className="flex items-center">
              ...
              <div className="w-12 border-2 border-[#989FAD]"></div>
              <div className="relative">
                <div className="bg-[#989FAD] h-[75px] w-[75px] rounded-full flex items-center justify-center">
                  <div className="bg-[#FFF] h-[65px] w-[65px] flex items-center justify-center rounded-full">
                    <MachiningIcon />
                  </div>
                </div>
                <div className="absolute top-[100px] text-center">
                  <h1 className="text-[#989FAD] text-sm font-[600]">
                    Machining
                  </h1>
                  <span>-</span>
                </div>
      ...
      <CastingResultModal
        open={data.modalResultQrCode}
        close={data.onResultQrCodeClose}
      />
    </>
  );
}
