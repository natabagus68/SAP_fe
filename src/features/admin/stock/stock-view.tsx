          ...
          <table>
            <thead className="text-[#667085] bg-[#F0F1F3] border-y-[2px] border-y-[#D0D3D9]">
              <tr className="text-left whitespace-nowrap">
                <th
                  className="px-4 border border-[#D0D3D9] text-sm font-[600]"
                  rowSpan={2}
                >
                  No
                </th>
                ...
                <th
                  className="px-4 border border-[#D0D3D9] text-sm font-[600] py-2"
                  colSpan={7}
                >
                  Delivery
                </th>
              ...
              <tr>
                <th className="p-4 border border-[#D0D3D9] text-sm font-[600]">
                  p
                </th>
                <th className="p-4 border border-[#D0D3D9] text-sm font-[600]">
                  H
            ...
            <tbody>
              <tr className="border-y text-left whitespace-nowrap">
