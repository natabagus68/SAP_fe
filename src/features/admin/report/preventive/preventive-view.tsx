      ...
      <div className="rounded-md border border-[#D0D3D9] bg-white">
        ...
        <table className="w-full">
          <thead className="bg-[#FAFAFB] border-b border-[#D0D3D9] h-[64px] text-sm text-[#514E4E] font-semibold">
            <tr>
              <th className="px-[32px] text-start">ID Preventive</th>
              <th className="px-[32px] text-start">Tanggal Preventive</th>
                ...
                <td className="px-[32px]">
                  <div className="flex items-center gap-6">
                    <button
                      ...
                      onClick={() => preventive.navigate(`${item.id}/details`)}
                    >
        ...
        <div className="w-[430px] flex flex-col gap-4">
          ...
          <div className="flex items-end gap-4">
            <button
              ...
              onClick={() => preventive.setOpenModalExport(false)}
            >
              Batal
            </button>
